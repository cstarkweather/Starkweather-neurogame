...
define('SETTINGS_DEFAULT_FILE', SETTINGS_DIR . 'settings_default.json');

$json_str = file_get_contents(SETTINGS_FILE);
$error = '';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($_POST["submit"] == "Revert to default"){
        $json_str = file_get_contents(SETTINGS_DEFAULT_FILE);
    }
    else{
